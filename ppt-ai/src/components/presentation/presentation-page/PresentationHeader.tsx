...
import PptAiText from "@/components/globals/ppt-ai-logo";
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Link href="/" className="h-max">
              <PptAiText className="h-10 w-[7.5rem] cursor-pointer transition-transform duration-100 active:scale-95"></PptAiText>
            </Link>
          </motion.div>
        </div>
